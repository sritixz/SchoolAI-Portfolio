            ...
            <div className="grid grid-cols-3 gap-4 mb-4">
                ...
                <div className="relative size-24">
                  <svg viewBox="0 0 36 36" className="size-24 -rotate-90">
                    ...
                    <circle cx="18" cy="18" r="15.9" fill="none" stroke="#695be6" strokeWidth="3"
                      strokeDasharray={`${d.overallCompletion || 0} ${100 - (d.overallCompletion || 0)}`} strokeLinecap="round" />
                  </svg>
                  <div className="absolute inset-0 flex flex-col items-center justify-center">
                    <span className="text-xl font-black text-[#100e1a]">{d.overallCompletion || 0}%</span>
              ...
              <div className="col-span-2 bg-white rounded-xl border border-gray-100 shadow-sm p-4">
                <div className="flex items-start gap-3 mb-4">
                  ...
                  <div>
                    <p className="font-black text-base">Forecast</p>
                    <p className="text-sm text-gray-600">
                      Syllabus completion expected by <span className="font-black text-[#100e1a]">{d.forecastDate}</span>.
                    </p>
                  </div>
                </div>
