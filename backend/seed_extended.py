...
async def seed_extended():
    ...
    career_docs = [
        # Tech domain
        {"domain_id": "tech", "id": "c_swe",   "title": "Software Engineer",     "subtitle": "Build & maintain systems",   "badge": "High Demand",  "badgeColor": "bg-[#695be6] text-white",
         "matchPercent": 85, "avgSalary": "₹12–40 LPA", "jobOpenings": "2.5L+", "growthOutlook": "Excellent", "yearsToQualify": "4 years",
         ...
         "dayInLife": ["Review code pull requests and provide feedback", "Attend daily standup meeting with the team", "Work on new feature development", "Debug and fix reported issues", "Write unit tests for new code"],
         "educationPath": [
        ...
        {"domain_id": "tech", "id": "c_ds",   "title": "Data Scientist",        "subtitle": "Insights from data",         "badge": "Top Paying",   "badgeColor": "bg-amber-500 text-white",
         "matchPercent": 78, "avgSalary": "₹15–50 LPA", "jobOpenings": "80K+", "growthOutlook": "Excellent", "yearsToQualify": "4-5 years",
         ...
         "dayInLife": ["Explore and clean datasets", "Build machine learning models", "Create data visualizations", "Present findings to stakeholders", "Collaborate with engineering teams"],
         "educationPath": [
        ...
        # Medical domain
        {"domain_id": "medical", "id": "c_doctor", "title": "Medical Doctor (MBBS)", "subtitle": "Heal and save lives", "badge": "Prestigious", "badgeColor": "bg-emerald-500 text-white",
         "matchPercent": 72, "avgSalary": "₹8–60 LPA", "jobOpenings": "1L+", "growthOutlook": "Excellent", "yearsToQualify": "5.5 years",
         ...
         "dayInLife": ["Morning ward rounds with patients", "Outpatient consultations", "Review test reports and diagnose", "Perform minor procedures", "Update patient records"],
         "educationPath": [
         ...
         "similarCareers": [
             {"id": "c_nurse", "title": "Nurse Practitioner", "matchPercent": 65},
             {"id": "c_pharma", "title": "Pharmacist", "matchPercent": 60},
         ],
